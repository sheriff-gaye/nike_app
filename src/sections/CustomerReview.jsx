import ReveiewCard from "../Components/ReveiewCard"
  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-24 flex flex-1 justify-evenly items-center max-lg:flex-col  gap-14">
        {
          reviews.map((review)=>(
            <ReveiewCard key={review.customerName} imgURL={review.imgURL} customerName={review.customerName} rating={review.rating}  feedback={review.feedback}/>
          ))
        }
